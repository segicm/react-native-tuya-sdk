...
class TuyaHomeModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(reactContext) {
    ...
    fun getHomeDetail(params: ReadableMap, promise: Promise) {
        if (ReactParamsCheck.checkParams(arrayOf(HOMEID), params)) {
            getHomeInstance(params.getDouble(HOMEID))?.getHomeDetail(getIThingHomeResultCallback(promise))
        }
    }
    ...
    fun getHomeLocalCache(params: ReadableMap, promise: Promise) {
        if (ReactParamsCheck.checkParams(arrayOf(HOMEID), params)) {
            getHomeInstance(params.getDouble(HOMEID))?.getHomeLocalCache(getIThingHomeResultCallback(promise))
        }
    }
    ...
    fun addRoom(params: ReadableMap, promise: Promise) {
        if (ReactParamsCheck.checkParams(arrayOf(HOMEID, NAME), params)) {
            getHomeInstance(params.getDouble(HOMEID))?.addRoom(params.getString(NAME), getIThingRoomResultCallback(promise))
        }
    }
    ...
    fun queryRoomList(params: ReadableMap, promise: Promise) {
        if (ReactParamsCheck.checkParams(arrayOf(HOMEID), params)) {
            getHomeInstance(params.getDouble(HOMEID))?.queryRoomList(IThingGetRoomListCallback(promise))
        }
    }
    ...
    fun IThingGetRoomListCallback(promise: Promise): IThingGetRoomListCallback? {
    ...
    fun getIThingRoomResultCallback(promise: Promise): IThingRoomResultCallback? {
    ...
    fun getIThingHomeResultCallback(promise: Promise): IThingHomeResultCallback? {
